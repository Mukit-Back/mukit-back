...
public class MenuService {
    ...
    public MenuResponseDTO.CreateMenu createMenu(Long shopId, MenuRequestDTO.CreateMenu createMenu) {
        Shop shop = shopRepository.findById(shopId).orElseThrow(()-> new ShopException(ShopErrorCode.SHOP_NOT_FOUND));

        Menu menu = MenuConverter.toMenu(createMenu, shop);
    ...
    public MenuResponseDTO.UpdateMenu updateMenu(Long menuId, MenuRequestDTO.UpdateMenu updateMenu) {
